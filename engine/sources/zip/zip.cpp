...
#ifndef ALLOC
# define ALLOC(size) (malloc_my(size))
#endif
#ifndef TRYFREE
# define TRYFREE(p) {if (p) free_my(p);}
#endif
...
#    ifndef NO_ADDFILEINEXISTINGZIP
    if (append == APPEND_STATUS_ADDINZIP)
    {
...

        {
            ...
            int buf_size = SIZEDATA_INDATABLOCK;
...
#    endif
    ...
    if (comment==NULL)
        ...
        size_comment = (uInt)strlen_my(comment);

    size_filename = (uInt)strlen_my(filename);
    ...
    const char* global_comment)
{
    ...
    if (global_comment==NULL)
        ...
        size_global_comment = (uInt)strlen_my(global_comment);
